...
// DOM elements
const extrasListView = document.getElementById('extras-list-view') as HTMLDivElement;
const editExtraView = document.getElementById('edit-extra-view') as HTMLDivElement;
const editExtraForm = document.getElementById('edit-extra-form') as HTMLFormElement;
const editExtraIndex = document.getElementById('edit-extra-index') as HTMLInputElement;
const editExtraName = document.getElementById('edit-extra-name') as HTMLInputElement;
const editExtraPrice = document.getElementById('edit-extra-price') as HTMLInputElement;
const extraCancelButton = document.getElementById('cancel-button') as HTMLButtonElement;
const extraSaveButton = document.getElementById('save-button') as HTMLButtonElement;
const addExtraButton = document.getElementById('add-extra-button') as HTMLButtonElement;
const extraBackButton = document.getElementById('back-button') as HTMLButtonElement;
...
async function handleExtraSave(): Promise<void> {
    ...
    try {
        ...
        if (response.ok) {
            ...
            alert(`Failed to ${isExtraAddMode ? 'add' : 'update'} extra. Please try again.`);
        }
    } catch (error) {
        console.error(`Error ${isExtraAddMode ? 'adding' : 'updating'} extra:`, error);
        alert(`Error ${isExtraAddMode ? 'adding' : 'updating'} extra. Please try again.`);
    } finally {
